...
namespace MoviesRegister
{
    public partial class PrincipalForm : BaseForm
    {
        ...
        {
            lblQuantidade.Text = "";
            lblQuantidadeFavoritos.Text = "";
            LocalizarFilmes();
            LocarlizarFilmesFavoritos();
        }
        ...
        private void LocarlizarFilmesFavoritos()
        {
            SortableBindingList<Movie> listaMovies = Movie.GetAllMovies();
            bdsFilmesFavoritos.DataSource = listaMovies;

            lblQuantidadeFavoritos.Text = "Quantidade: " + bdsFilmesFavoritos.Count;
        }
    }
}
